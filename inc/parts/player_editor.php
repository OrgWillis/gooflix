...
<table id="repeatable-fieldset-one" width="100%" class="dt_table_admin">
    <thead>
        <tr>
            <th>#</th>
            <th><?php _e('Title', 'mega'); ?></th>
            <th><?php _e('Type', 'mega'); ?></th>
            <th><?php _e('ID or URL', 'mega'); ?></th>
            <th><?php _e('Control', 'mega'); ?></th>
        </tr>
    </thead>
    <tbody>
        <?php if($postmneta) : foreach ($postmneta as $field) { ?>
            <tr class="tritem">
                <td class="draggable"><span class="dashicons dashicons-move"></td>
                    ...
                    <td><a class="button remove-row" href="#"><?php _e('Remove', 'mega'); ?></a></td>
                </tr>
            <?php } else : ?>
            <tr class="tritem">
                <td class="draggable"><span class="dashicons dashicons-move"></td>
        ...
        <!-- Link Add Row -->
        <p class="repeater"><a id="add-row" class="add_row" href="#"><?php _e('Add new row', 'mega'); ?></a></p>
