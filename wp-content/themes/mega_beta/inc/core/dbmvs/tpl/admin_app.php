<div id="dbmovies-dbmvs-application" class="dbmovies-app">
    ...
    <header class="dbmvsapp">
        ...
        <nav class="left" id="dbmovies-types">
            <ul>
                <li><h3>Dbmvs</h3></li>
                <li><a href="#" class="dbmvs-tab-content button button-primary" data-type="movie"><?php _e('Movies','mega'); ?></a></li>
                <li><a href="#" class="dbmvs-tab-content button" data-type="tv"><?php _e('TV Shows','mega'); ?></a></li>
                <li class="dbmvs-results-screem"><?php _e('Results','mega'); ?> <strong id="dbmvs-results-number">0</strong></li>
            </ul>
        </nav>
        ...
        <nav class="right" id="dbmovies-settings">
            <ul>
                <li class="dbmvs-credits" style="display:none">
                    <strong><?php _e('Credits'); ?>:</strong> <span id="dbmvs-credits">0</span>
                ...
                <li id="dbmovies-li-imdb">
                    ...
                    <a href="#" id="dbmvs-imdb"><b><?php _e('IMDb Updater','mega'); ?></b></a>
                </li>
            </ul>
        </nav>
    ...
    <div id="dbmvs-forms-response" class="forms">
        ...
        <form id="dbmovies-form-filter">
            <fieldset>
                <a class="button dbmovies-log-collapse" href="#"><?php _e('Expand'); ?></a>
            </fieldset>
            <fieldset>
                <input type="number" id="dbmvs-year" min="1900" max="<?php echo date('Y')+1; ?>" name="year" value="<?php echo rand('1950', date('Y')); ?>" placeholder="<?php _e('Year','mega'); ?>">
            </fieldset>
            <fieldset>
                <input type="number" id="dbmvs-page" min="1" name="page" value="1" placeholder="<?php _e('Page','mega'); ?>">
            </fieldset>
            <fieldset>
                <select id="dbmvs-popularity" name="popu">
                    <option value="popularity.desc"><?php _e('Popularity desc','mega'); ?></option>
                    <option value="popularity.asc"><?php _e('Popularity asc','mega'); ?></option>
                </select>
            </fieldset>
            ...
            <fieldset>
                <input type="submit" id="dbmvs-btn-filter" class="button" value="<?php _e('Filter','mega'); ?>">
            ...
            <fieldset id="bulk-importer-click">
                <a href="#" id="bulk-importer" class="button button-primary"><?php _e('Bulk import','mega'); ?></a>
            </fieldset>
        </form>
        ...
        <form id="dbmovies-form-search" class="right">
            <fieldset>
                <input type="text" id="dbmvs-search-term" name="searchterm" placeholder="<?php _e('Search..','mega'); ?>">
            </fieldset>
            <fieldset>
                <input type="submit" id="dbmvs-btn-search" class="button" value="<?php _e('Search','mega'); ?>">
    ...
    <div class="wrapp">
        <div class="content">
            ...
            <div class="paginator">
                ...
                <a href="#" id="dbmovies-loadmore" class="button dbmvsloadmore"><?php _e('Load More','mega'); ?></a>
            </div>
        </div>
    </div>
</div>
